...
- **script.py** (6 connections) — `AnonGee.extension/AnonGee.tab/Essential.panel/Bulk Tool.stack/Bulk Delete.pulldown/Delete LinePatterns.pushbutton/script.py`
...
- **run()** (4 connections) — `AnonGee.extension/AnonGee.tab/Essential.panel/Bulk Tool.stack/Bulk Delete.pulldown/Delete LinePatterns.pushbutton/script.py`
...
- **.show()** (2 connections) — `AnonGee.extension/AnonGee.tab/Essential.panel/Bulk Tool.stack/Bulk Delete.pulldown/Delete LinePatterns.pushbutton/script.py`
...
- **_collect_fillpatterns()** (1 connections) — `AnonGee.extension/AnonGee.tab/Essential.panel/Bulk Tool.stack/Bulk Delete.pulldown/Delete LinePatterns.pushbutton/script.py`
- **_collect_linepatterns()** (1 connections) — `AnonGee.extension/AnonGee.tab/Essential.panel/Bulk Tool.stack/Bulk Delete.pulldown/Delete LinePatterns.pushbutton/script.py`
- **_collect_linestyles()** (1 connections) — `AnonGee.extension/AnonGee.tab/Essential.panel/Bulk Tool.stack/Bulk Delete.pulldown/Delete LinePatterns.pushbutton/script.py`
