...
- **get_element_name()** (8 connections) — `AnonGee.extension/lib/py3/anongee_toolkit/cad2bim/compat.py`
...
- **compat.py** (5 connections) — `AnonGee.extension/lib/py3/anongee_toolkit/cad2bim/compat.py`
...
- [[columns.py]] (5 shared connections)
- [[geometry_reader.py]] (3 shared connections)
